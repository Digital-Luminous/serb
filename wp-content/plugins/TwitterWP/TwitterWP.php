...
if ( ! class_exists( 'TwitterWP' ) ) :
	...
	class TwitterWP {
		...
		public function user_exists( $user_id = '' ) {
			...
			$args = apply_filters( 'twitterwp_get_user', $this->header_args( '' ) );
			$response = wp_remote_get( 'https://api.twitter.com/1.1/users/lookup.json?user_id=' . self::$user_id, $args );
