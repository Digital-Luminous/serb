...
$proURL = $upgradePath = "https://go.premio.io/?edd_action=add_to_cart&download_id=687&edd_options[price_id]=";
...
$plans = [
    '1_website' => [
        ...
        '2_years' => [
            ...
            'month' => 2.9,
            'price_id' => 38,
            'link' => isset($upgrades[38])?($upgradePath.$upgrades[38]):($proURL."38"),
        ...
        'lifetime' => [
            ...
            'month' => 0,
            'price_id' => 39,
            'link' => isset($upgrades[39])?($upgradePath.$upgrades[39]):($proURL."39"),
    ...
    '5_websites' => [
        '1_year' => [
            ...
            'month' => 9.1,
            'price_id' => 40,
            'link' => isset($upgrades[40])?($upgradePath.$upgrades[40]):($proURL."40"),
            'title' => esc_html__("1 year", "folders"),
            'mobile_title' => esc_html__("Updated and support for 1 year", "folders"),
        ],
        '2_years' => [
            ...
            'month' => 7.1,
            'price_id' => 41,
            'link' => isset($upgrades[41])?($upgradePath.$upgrades[41]):($proURL."41"),
            'title' => esc_html__("2 years", "folders"),
            'mobile_title' => esc_html__("Updated and support for 2 years", "folders"),
        ],
        'lifetime' => [
            ...
            'month' => 0,
            'price_id' => 42,
            'link' => isset($upgrades[42])?($upgradePath.$upgrades[42]):($proURL."42"),
            'title' => esc_html__("Lifetime", "folders"),
            'mobile_title' => esc_html__("Updated and support for lifetime", "folders")
        ]
    ],
    '50_websites' => [
        '1_year' => [
            ...
            'month' => 15,
            'price_id' => 43,
            'link' => isset($upgrades[43])?($upgradePath.$upgrades[43]):($proURL."43"),
            'title' => esc_html__("1 year", "folders"),
            'mobile_title' => esc_html__("Updated and support for 1 year", "folders"),
        ],
        '2_years' => [
            ...
            'month' => 11.7,
            'price_id' => 44,
            'link' => isset($upgrades[44])?($upgradePath.$upgrades[44]):($proURL."44"),
            'title' => esc_html__("2 years", "folders"),
            'mobile_title' => esc_html__("Updated and support for 2 years", "folders"),
        ],
        'lifetime' => [
            ...
            'month' => 0,
            'price_id' => 45,
            'link' => isset($upgrades[45])?($upgradePath.$upgrades[45]):($proURL."45"),
            'title' => esc_html__("Lifetime", "folders"),
            'mobile_title' => esc_html__("Updated and support for lifetime", "folders")
        ]
    ],
    '500_websites' => [
        '1_year' => [
            ...
            'month' => 29.1,
            'price_id' => 46,
            'link' => isset($upgrades[46])?($upgradePath.$upgrades[46]):($proURL."46"),
            'title' => esc_html__("1 year", "folders"),
            'mobile_title' => esc_html__("Updated and support for 1 year", "folders"),
        ],
        '2_years' => [
            ...
            'month' => 21.7,
            'price_id' => 47,
            'link' => isset($upgrades[47])?($upgradePath.$upgrades[47]):($proURL."47"),
            'title' => esc_html__("2 years", "folders"),
            'mobile_title' => esc_html__("Updated and support for 2 years", "folders"),
        ],
        'lifetime' => [
            ...
            'month' => 0,
            'price_id' => 48,
            'link' => isset($upgrades[48])?($upgradePath.$upgrades[48]):($proURL."48"),
            'title' => esc_html__("Lifetime", "folders"),
            'mobile_title' => esc_html__("Updated and support for lifetime", "folders")
        ]
    ],
    '1000_websites' => [
        '1_year' => [
            ...
            'month' => 40,
            'price_id' => 49,
            'link' => isset($upgrades[49])?($upgradePath.$upgrades[49]):($proURL."49"),
            'title' => esc_html__("1 year", "folders"),
            'mobile_title' => esc_html__("Updated and support for 1 year", "folders"),
        ],
        '2_years' => [
            ...
            'month' => 30.5,
            'price_id' => 50,
            'link' => isset($upgrades[50])?($upgradePath.$upgrades[50]):($proURL."50"),
            'title' => esc_html__("2 years", "folders"),
            'mobile_title' => esc_html__("Updated and support for 2 years", "folders"),
        ],
        'lifetime' => [
            ...
            'month' => 0,
            'price_id' => 51,
            'link' => isset($upgrades[51])?($upgradePath.$upgrades[51]):($proURL."51"),
            'title' => esc_html__("Lifetime", "folders"),
            'mobile_title' => esc_html__("Updated and support for lifetime", "folders")
        ]
    ]
...
$features = [
    ...
    [
        ...
        'tooltip' => esc_html__("Automatically filter posts/pages/custom posts/media files based on author, date, file types & more ", "folders")."<img src='".WCP_PRO_FOLDER_URL."assets/images/dynamic-folders.gif' alt='".esc_html__("Dynamic Folders", "folders")."' />"
    ],
    [
    ...
    [
        ...
        'tooltip' => esc_html__("Advanced access management for your team with roles that restrict their access to view and edit your folders.", "folders")."<img src='".WCP_PRO_FOLDER_URL."assets/images/user-access.jpg' alt='".esc_html__("Metadata details on Media Library hover", "folders")."' />"
    ],
    [
    ...
    [
        ...
        'tooltip' => esc_html__("Show useful metadata including title, size, type, date, dimension & more on hover.", "folders")."<img src='".WCP_PRO_FOLDER_URL."assets/images/folders-media.gif' alt='".esc_html__("Metadata details on Media Library hover", "folders")."' />"
    ],
    [
            ...
            <div class="manage-plans">
                <div class="manage-plan-header">
                    <div class="plan-header-left">
                        <?php esc_html_e("Current Plan", "folders"); ?>
                    </div>
                    <div class="plan-header-right">
                        <a href="<?php echo esc_url($licenseURL) ?>">
                            ...
                            <?php esc_html_e("My License Key", "folders"); ?>
                        </a>
                    </div>
                </div>
                    ...
                    <?php if($licenseData['license'] == "expired") { ?>
                        <div class="manage-plan">
                            ...
                            <div class="plan-website-limit">
                                (<?php echo sprintf(esc_html__("%d of %d websites used", "folders"), esc_attr($siteCount), esc_attr($totalActivation)); ?>)
                            </div>
                                ...
                                <?php if($expireDate == "lifetime") {
                                    ...
                                    if(isset($response['data']['rec_amount'])) { ?>
                                        <div class="renewal-desc">
                                            <?php echo sprintf(esc_html__("You will be billed %s", "folders"), "<b>$".esc_attr($response['data']['rec_amount'])."</b>") ?>
                                        </div>
                                    <?php }
                                } ?>
                            </div>
            ...
            <div class="plan-details-bottom">
                <div class="plan-options">
                    ...
                    <div class="plan-option" data-id="2_years">
                        <div class="plan-title"><?php esc_html_e("2 years ", "folders"); ?>
                            <span>(32% Off
...
<div class="pricing-bottom">
    <div class="price-container">
        ...
        <div class="money-guaranteed">
            ...
            <div class="payments">
                <img src="<?php echo esc_url(WCP_PRO_FOLDER_URL."assets/images/payment.png") ?>" alt="Payment" class="payment-img" />
            </div>
        </div>
    </div>
</div>
            ...
            <div class="testimonial-list">
                ...
                $reviews = [
                    [
                        ...
                        'image'     => WCP_PRO_FOLDER_URL . 'assets/images/testimonials/cris-brandy.webp',
                    ...
                    [
                        ...
                        'image'     => WCP_PRO_FOLDER_URL . 'assets/images/testimonials/martin.webp',
                    ...
                    [
                        ...
                        'image'     => WCP_PRO_FOLDER_URL . 'assets/images/testimonials/ana.webp',
                    ...
                    [
                        ...
                        'image'     => WCP_PRO_FOLDER_URL . 'assets/images/testimonials/ian.webp',
                    ...
                    [
                        'name'      => 'industryqorf',
                        'image'     => WCP_PRO_FOLDER_URL . 'assets/images/testimonials/industryqorf.webp',
                    ...
                    [
                        'name'      => 'jbalog',
                        'image'     => WCP_PRO_FOLDER_URL . 'assets/images/testimonials/jbalog.webp',
                    ...
                    [
                        'name'      => 'marinahleal',
                        'image'     => WCP_PRO_FOLDER_URL . 'assets/images/testimonials/marinahleal.webp',
                    ...
                    [
                        'name'      => 'rahrah1',
                        'image'     => WCP_PRO_FOLDER_URL . 'assets/images/testimonials/rahrah1.webp',
                    ...
                    [
                        'name'      => 'rmiller3000',
                        'image'     => WCP_PRO_FOLDER_URL . 'assets/images/testimonials/rmiller3000.webp',
...
<div class="premio-customers">
    <div class="price-container">
        ...
        <img src="<?php echo esc_url(WCP_PRO_FOLDER_URL."assets/images/companies.webp") ?>" alt="premio customers" />
    </div>
</div>
...
<div class="hide-plan-page">
    ...
    <a href="#" id="hide-plan-page"><?php esc_html_e('Hide "Manage Your Plan" page', 'folders'); ?></a>
</div>
...
<script type="text/javascript">
    (function (factory) {
        ...
        $(document).on("click", "#hide-plan-page", function(e){
            e.preventDefault();
            if(confirm("<?php esc_html_e("Are you sure?", "folders"); ?>\nTo view this page again, you'll need to deactivate and reactivate the license key.")) {
                window.location = "<?php echo esc_url($this->getRegisterKeyURL()."&action=hide_folders_plans&token=".wp_create_nonce("hide_folders_plans")); ?>"
            }
        });
            ...
            if($("select.multiple-options").length) {
                $(document).on("change", "select.multiple-options", function(){
                    ...
                    if(typeof pluginPlans[planName] !== "undefined" && typeof pluginPlans[planName][selectedId] !== "undefined") {
                        ...
                        $(this).closest(".plan-info").removeClass("has-current-plan");
                        if(currentPlan == parseInt(selectedPlan.price_id)) {
                            ...
                            $(this).closest(".plan-info").addClass("has-current-plan");
