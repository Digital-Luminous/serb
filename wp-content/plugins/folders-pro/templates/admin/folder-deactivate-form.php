        ...
        <form action="#" method="post" id="folder-deactivate-form">
            ...
            <div class="folder-popup-body">
                ...
                <div class="form-control">
                    <input type="email" value="<?php echo esc_attr(get_option('admin_email')) ?>" placeholder="<?php echo esc_html__("Email address", 'folders') ?>" id="folder-deactivate-email_id">
                </div>
                <div class="form-control">
                    <label></label>
...
<script>
    (function ($) {
        ...
        $(function () {
            ...
            var folderProPluginSlug = 'folders';
            // Code to fire when the DOM is ready.

            $(document).on('click', 'tr[data-slug="' + folderProPluginSlug + '"] .deactivate', function (e) {
                e.preventDefault();
            ...
            $(document).on('click', ".folder-serveypanel,tr[data-slug='" + folderProPluginSlug + "'] .deactivate", function (e) {
                e.stopPropagation();
            });
            ...
            $(document).on('submit', '#folder-deactivate-form', function (event) {
                ...
                $.ajax({
                    ...
                    window.location.href = $("tr[data-slug='" + folderProPluginSlug + "'] .deactivate a").attr('href');
                });
            });
