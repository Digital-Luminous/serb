                    ...
                    <div class="plugin-card-bottom">
                        ...
                        <div class="column-compatibility">
                            ...
                            if (! $tested_wp) {
                                ...
                                echo '<span class="compatibility-incompatible">'.wp_kses( '<strong>Incompatible</strong> with your version of WordPress', $plugins_allowedtags).'</span>';
                            } else {
                                echo '<span class="compatibility-compatible">'.wp_kses( '<strong>Compatible</strong> with your version of WordPress', $plugins_allowedtags).'</span>';
                            }
                            ?>
                        </div>
                    </div>
