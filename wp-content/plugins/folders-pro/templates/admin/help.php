...
<div class="folder-help-form">
    <form action="<?php echo esc_url(admin_url('admin-ajax.php')) ?>" method="post" id="folder-help-form">
        <div class="folder-help-header">
            <?php printf(esc_html__("%s Co-Founder at Premio", "folders"), " <b>Gal Dubinski</b>"); ?>
        </div>
...
<div class="folder-help-btn">
    ...
    <a class="folder-help-tooltip" href="javascript:;"><img src="<?php echo esc_url(WCP_PRO_FOLDER_URL."assets/images/owner.jpg") ?>" alt="<?php esc_html_e("Need help?", 'folders'); ?>"  /></a>
    <?php
    $option = get_option("hide_folders_cta");
    if ($option !== "yes") { ?>
        <span class="tooltiptext"><?php esc_html_e("Need help?", "folders"); ?></span>
    <?php } ?>
</div>
<script>
