...
//        $this->reviewStatus = true;
    ...
    public function enqueue_scripts() {
        if (current_user_can('manage_options')) {
            wp_enqueue_style($this->pluginSlug."-star-rating-svg", plugins_url('../assets/css/star-rating-svg.css', __FILE__), [], WCP_PRO_FOLDER_VERSION);
            wp_enqueue_script($this->pluginSlug."-star-rating-svg", plugins_url('../assets/js/jquery.star-rating-svg.min.js', __FILE__), ['jquery'], WCP_PRO_FOLDER_VERSION,false);
        }
    }
    ...
    public function admin_notices()
    {
        ...
        <div class="notice notice-info premio-notice <?php echo esc_attr($this->pluginSlug) ?>-premio-review-box">
            ...
            <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default">
                ...
                <p><?php printf( esc_html__("Hi there, it seems like %1\$s is bringing you some value, and that's pretty awesome! Can you please show us some love and rate %2\$s on WordPress? It'll only take 2 minutes of your time, and will really help us spread the word", 'folders'), "<b>".esc_attr($this->pluginName)."</b>", esc_attr($this->pluginName));?></p>
                ...
                <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default__co-founder">
                    ...
                    <img class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default__co-founder-img" width="30" height="30" src="<?php echo esc_url(WCP_PRO_FOLDER_URL."assets/images/owner.jpg") ?>" />
                </div>
            ...
            <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__thank-you">
                <div class="thanks-wrap">
                    ...
                    <img class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__thank-you__image" width="200" src="<?php echo esc_url(WCP_PRO_FOLDER_URL."assets/images/thanks.gif") ?>" />
        ...
        <script>
            (function($) {
                ...
                $(document).ready(function(){
                    ...
                    FoldersProReview.prototype.getSelectors = function() {
                        return {
                            body: 'body',
                    ...
                    FoldersProReview.prototype.getElements = function() {
                    ...
                    FoldersProReview.prototype.bindEvents = function() {
                    ...
                    FoldersProReview.prototype.feedbackFormHandler = function(ev) {
                        ev.preventDefault();
                        const elements  = this.getElements();
                    ...
                    FoldersProReview.prototype.thankYouDismissHandler = function() {
                        const elements = this.getElements();
                        elements.$reviewBox.remove();
                        elements.$reminderPopup.remove();
                        this.sendHideRequest( -1 );
                    ...
                    FoldersProReview.prototype.reminderHandler = function(ev) {
                        ev.preventDefault();
                    ...
                    FoldersProReview.prototype.sendHideRequest = function( dataDays = -1 ) {
                        $.ajax({
                            url: "<?php echo esc_url(admin_url("admin-ajax.php")) ?>",
                    ...
                    FoldersProReview.prototype.toggleReminderPopup = function( action = true ) {
                        if( action ) {
                    ...
                    FoldersProReview.prototype.feedbackToggle = function( action = true ) {
                        const elements = this.getElements();
                        console.log(action);
                        if( action ) {
                    ...
                    FoldersProReview.prototype.renderRating = function() {
                        const self      = this;
...
$Folders_Pro_Review_Box = new Folders_Pro_Review_Box();
